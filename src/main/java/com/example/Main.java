...
import com.example.concurency.MyCallable;
...
public class Main {
    ...
    private static void runThread() {
        ...
        Arrays.asList(thread1, thread2, thread3, thread4, thread5, thread6).parallelStream().forEach(Thread::start);
    }
    ...
    private static void runConcurrency() throws InterruptedException {
        ...
        List<Future<String>> futures = executor.invokeAll(Arrays.asList(callable1, callable2, callable3, callable4,
                callable5, callable6));
